const Home = () => {
  return (
    <div className="">
      <div className="flex flex-col h-[700px] items-center justify-center pt-20 space-y-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 font-display sm:text-5xl md:text-6xl xl:text-7xl">
          Component<span className="text-blue-700">UI</span>
        </h1>
        ...
        <div className="flex items-center justify-center mt-5 gap-4">
          <div className="social-button ">
            <button className="relative w-12 h-12 rounded-full group">
              <div className="floater w-full h-full absolute top-0 left-0 bg-violet-400 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-2xl"></div>
              <div className=" relative z-10 w-full h-full flex items-center justify-center border-2 border-violet-400 rounded-full ">
                <svg
          ...
          <div className="social-button">
            <button className="relative w-12 h-12 rounded-full group">
              <div className="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-2xl"></div>
          ...
          <div className="social-button">
            <button className="relative w-12 h-12 rounded-full group">
              <div className="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-2xl"></div>
          ...
          <div className="social-button">
            <button className="relative w-12 h-12 rounded-full group">
              <div className="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-2xl"></div>
