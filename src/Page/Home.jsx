...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-[700px] items-center justify-center pt-20 space-y-8 px-4">
        <div className="relative">
          <div className="absolute -inset-1  rounded-lg blur opacity-30 animate-pulse"></div>
          <h1 className="relative text-4xl font-extrabold tracking-tight text-gray-900 font-display sm:text-5xl md:text-6xl xl:text-7xl">
            Component<span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-700">UI</span>
          </h1>
        </div>
        
        <p className="text-2xl font-medium text-gray-800 text-center animate-fade-in">
          Free React Tailwind component library
        </p>
        <p className="text-lg font-medium text-gray-600 max-w-2xl text-center leading-relaxed">
          Discover a world of reusable, customizable Tailwind components to
          elevate your projects. Built with modern design principles.
        </p>

        {/* Get Started Button */}
        {/* <button className="mt-4 px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-full hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-150 hover:from-blue-700 hover:to-blue-800">
          Get Started
        </button> */}
        ...
        <div className="">
          <div className="flex items-center justify-center gap-6 flex-wrap">
            {/* Instagram button */}
            <div className="social-button transform hover:-translate-y-1 transition-all duration-300">
              <button className="relative w-14 h-14 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-gradient-to-br from-violet-400 to-violet-500 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-xl"></div>
                <div className="relative z-10 w-full h-full flex items-center justify-center border-2 border-violet-400 rounded-full hover:border-violet-500 transition-colors">
                  <svg
                  ...
                  >
                    <path
                      className="fill-[#171543] group-hover:fill-white duration-300"
            ...
            <div className="social-button transform hover:-translate-y-1 transition-all duration-300">
              <button className="relative w-14 h-14 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-gradient-to-br from-gray-800 to-black rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-gray-800 rounded-full hover:border-gray-900 transition-colors">
                  <svg
                    height="24"
                    width="24"
                    viewBox="0 0 24 24"
            ...
            <div className="social-button transform hover:-translate-y-1 transition-all duration-300">
              <button className="relative w-14 h-14 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full hover:border-blue-600 transition-colors">
                  <svg
                    height="24"
                    width="24"
                    viewBox="0 0 24 24"
            ...
            <div className="social-button transform hover:-translate-y-1 transition-all duration-300">
              <button className="relative w-14 h-14 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-gradient-to-br from-red-400 to-red-500 rounded-full duration-300 transform scale-0 group-hover:scale-100 group-hover:shadow-xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full hover:border-red-500 transition-colors">
                  <svg
                    height="32"
                    width="32"
                    viewBox="0 0 32 32"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="text-center p-6 backdrop-blur-sm bg-white/30 rounded-2xl border border-white/20">
