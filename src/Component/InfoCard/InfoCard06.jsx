...
const code =`<div
  className="fitCard flex min-h-[24em] min-w-[18em] w-96 mx-auto flex-col items-center justify-center gap-[0.5rem] rounded-[1.5em] bg-[#FFFACD] p-[0.5rem] font-monts text-[#B49A18]"
>
  <div
  ...
  >
    <p
      className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[1rem] font-bold duration-500 group-hover:-translate-x-[300%]"
    >
      Today's Quote
    </p>
    <p
      className="absolute left-1/2 top-1/2 h-fit w-full -translate-y-1/2 translate-x-1/2 px-[1rem]  text-[0.75rem] font-bold  duration-500 group-hover:-translate-x-1/2 text-center"
    >
