...
const InfoCard05 = () => {
    const code =`<div className="grid grid-cols-2 w-[700px] mx-auto gap-2 max-[500px]:grid-cols-1 px-3">
  <div
    className="group w-full rounded-lg bg-[#673ab7] p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3]"
  >
  ...
  <div
    className="group w-full rounded-lg bg-[rgb(41,49,79)] p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_rgb(244,67,54)]"
  >
  ...
  return (
    <Container code={code}>
<div className="grid grid-cols-2 w-[700px] mx-auto gap-2 max-[500px]:grid-cols-1 px-3">
  <div
    className="group w-full rounded-lg bg-[#673ab7] p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3]"
  >
    <p className="text-white text-2xl">2000</p>
