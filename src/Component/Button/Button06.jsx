...
const Button06 = () => {
  const code=`<div className="relative flex items-center justify-center">
        <input
          type="checkbox"
          id="react-option"
          value=""
        ...
        ></label>
        <svg
          className="absolute stroke-sky-800 size-12 duration-300 peer-checked:opacity-100 opacity-0"
          height="100"
        ...
        <svg
          className="absolute  stroke-yellow-500 size-12 duration-300 peer-checked:opacity-0 opacity-100"
          height="100"
          preserveAspectRatio="xMidYMid meet"
          viewBox="0 0 100 100"
          width="100"
