...
const Button12 = () => {
  const code = ` <button className="bg-[#ADD8E6] px-6 py-3 text-white relative overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 rounded tracking-wider font-semibold">
          Hover Me
          <svg
  ...
  return (
    <Container code={code}>
      <div className="flex justify-center">
        <button className="bg-[#ADD8E6] px-6 py-3 text-white relative overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 rounded tracking-wider font-semibold">
          Hover Me
          <svg
            className="absolute inset-0 left-0 top-0 fill-sky-300 -z-30 opacity-0 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all group-active:fill-sky-950"
            preserveAspectRatio="xMidYMid meet"
