...
const Search02 = () => {
  const code = `<div className="relative rounded-full overflow-hidden bg-white shadow-xl w-3/4">
          <input
            type="text"
            name="text"
  ...
  return (
    <Container code={code}>
      <div className="flex justify-center">
        <div className="relative rounded-full overflow-hidden bg-white shadow-xl w-96 mx-auto">
          <input
            type="text"
            name="text"
            placeholder="Hover on Submit"
