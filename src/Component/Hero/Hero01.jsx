...
const Hero01 = () => {
    const code = `<div className="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0 bg-white">
      ...
      <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl ">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <div className="flex items-center">
            <a
              href="/"
              className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-purple-900 hover:bg-purple-700 hover:text-white focus:shadow-outline focus:outline-none"
            >
              Get started
            </a>
            <a
